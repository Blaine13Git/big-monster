package com.muyi.bigMonster.result;

import com.muyi.bigMonster.exceptions.ErrorCodeEnum;
...
public class Result<T> implements Serializable {
    ...
    public static Result Failure(@NotNull ErrorCodeEnum errorCodeEnum){
        Result result = Failure();
        result.setStatus(false);
        result.setResponseCode(errorCodeEnum.getStatus());
        result.setMessage(errorCodeEnum.getMsg());
        return result;
    }
